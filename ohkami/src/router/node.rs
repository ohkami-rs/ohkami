...
use crate::{
    ...
    error::ElseResponse,
    response::Response, fang::Fang, handler::HandleFunc,
};


pub(super) struct Node<'router> {
    pub(super) pattern:     Pattern,
    pub(super) handle_func: Option<HandleFunc<'router>>,
    pub(crate) fangs:       Vec<Fang<'router>>,
    pub(super) children:    Children<'router>,
}
